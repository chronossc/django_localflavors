...
from cpfcnpj.webui.models import CPFCNPJModel
...
class BRCPFCNPJTests(TestCase):
    ...
    def test_cpfcnpj_form_and_model(self):
        # inserts 50 register on cpfcnpj model with form
        for i in xrange(50):
            cpf = self.randomcpf
            cnpj = self.randomcnpj
            ...
            f = CPFCNPJForm(data={'cpf':cpf_to_form,'cnpj':cnpj_to_form})
            ...
            try:
                inst = CPFCNPJModel.objects.get(cpf=cpf,cnpj=cnpj)
